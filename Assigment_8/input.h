...
namespace input {
	...
	static string inputString(string prompt, bool haveSpaces, int length)
	{
		string input;
		while (true)
		{
	...
	//return an input string
	static string inputString(string prompt, bool haveSpaces)
	{
		string input;
		cout << prompt;
		if (haveSpaces)
	...
	static char inputChar(string prompt, string listChars)
	{
		char input;
		while (true)
		{
	...
	//return an input char
	static char inputChar(string prompt, char yes, char no)
	{
		char input;
		do
		{
	...
	//return an input char
	static char inputChar(string prompt, bool alphaOrDigit)
	{
		char input;
		do
		{
	...
	static int inputInteger(string prompt, bool posNeg)
	{
		int input;
		do
		{
	...
	static int inputInteger(string prompt, int startRange, int endRange)
	{
	...
	static double inputDouble(string prompt, bool posNeg)
	{
		double input;
		do
		{
